# Generated by Django 4.0.10 on 2025-06-23 17:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', neutrino.account.Field.PhoneField(max_length=12, validators=[neutrino.account.validator.PhoneValidator])),
                ...
                ('connection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='FOLLOWING', to=settings.AUTH_USER_MODEL)),
                ('forward_connection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='FOLLOWER', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_seen_profiles_day', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='SeenProfile', related_query_name='seenprofiles', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_info', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='Profile_Info', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
